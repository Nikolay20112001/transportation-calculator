...
describe('DeliveryCostCalculator - calculateCost INTEGRATIONS', () => {
  ...
  it('should calculate delivery cost correctly temlate mode', async () => {
    const mockCoordsResponse = { lat: 51.5074, lon: -0.1278 };
    const mockDistanceResponse = 993187.7;
  ...
  it('should be overweight error in template mode', async () => {
    const mockCoordsResponse = { lat: 51.5074, lon: -0.1278 };
    const mockDistanceResponse = 993187.7;
  ...
  it('should calculate delivery cost correctly template mode', async () => {
    const mockCoordsResponse = { lat: 51.5074, lon: -0.1278 };
    const mockDistanceResponse = 993187.7;
